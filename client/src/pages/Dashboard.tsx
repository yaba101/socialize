			...
			<div className='max-w-screen-xl px-4 py-8 mx-auto sm:py-12 sm:px-6 lg:px-8 '>
				...
				<div className='sm:flex sm:items-center sm:justify-between'>
					<div className='text-center sm:text-left'>
						...
						<button
							className='block mt-5 mx-auto px-5 py-3 text-sm font-medium text-white transition bg-indigo-600 rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring '
					...
					<div className='flex flex-col gap-4 sm:mt-0 sm:flex-row sm:items-center'>
						...
						<button
							className='block px-3 py-3 text-sm font-medium text-white transition rounded-md bg-cyan-600 hover:bg-cyan-700 focus:outline-none focus:ring'
							onClick={() => {
								logout()
